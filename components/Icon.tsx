...
interface IconProps extends React.SVGProps<SVGSVGElement> {
  name: 'upload' | 'check' | 'x' | 'lightbulb' | 'link' | 'video' | 'case' | 'refresh' | 'academic-cap' | 'book-open' | 'plus' | 'trash' | 'drag-handle' | 'image' | 'history' | 'search' | 'globe' | 'leaf' | 'map' | 'moon' | 'sun' | 'sparkles' | 'rocket' | 'chart-bar' | 'arrow-right';
}
